...
def valid_letter(letter_input, secret_word):
    '''
    valid_letter: takes letter input from user, checks if it is correct.
    returns: if correct = True, if incorrect = False.
    '''
    for char in secret_word:
...
def hangman(secret_word):
    ...
    * After each guess, you should display to the user the 
    ...
    #print("You have ", number_of_guesses, "number of guesses")
    
    while number_of_guesses > 0:
        print ("you have ", number_of_guesses, " guesses left.")
        print("Availablle letters: ", get_available_letters(letters_guessed))
